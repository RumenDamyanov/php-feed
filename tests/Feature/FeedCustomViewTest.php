...
test('feed custom view is set and retrieved', function () {
    $feed = new Feed([
    ...
    expect($feed->getCustomView())->toBe('custom.view');
    $feed->setCustomView(null);
    expect($feed->getCustomView())->toBeNull();
});
